...
.header{margin:14px 14px 13px;border:1px solid #cfe7fa;border-radius:13px;background:linear-gradient(106deg,#0a4d9a 0%,#0875df 48%,#35a8ef 100%);height:108px;display:flex;align-items:center;justify-content:space-between;padding:14px 15px 14px 25px;position:relative;overflow:hidden;box-shadow:0 5px 16px rgba(20,104,176,.12)}.header:before{content:"";position:absolute;width:58%;height:190px;right:7%;top:-112px;border-radius:50%;background:linear-gradient(145deg,rgba(88,190,247,.24),rgba(255,255,255,0));transform:rotate(-16deg)}.header:after{content:"";position:absolute;width:46%;height:100px;right:11%;bottom:-65px;border-radius:50%;border-top:2px solid rgba(255,224,128,.62);transform:rotate(-10deg)}.brand{display:flex;align-items:center;gap:14px;position:relative;z-index:2}.brand-icon{width:100px;height:92px;display:grid;place-items:center;flex:none}.gold-mark{position:relative;width:45px;height:40px;display:block;flex:none}.gold-mark-large{width:112px;height:92px}.gold-mark{position:relative;width:40px;height:30px;display:block;flex:none}.gold-mark:before{content:"";position:absolute;left:4px;top:7px;width:31px;height:18px;border-radius:3px 3px 5px 5px;background:linear-gradient(155deg,#fff4a8 0%,#f7cd4c 35%,#d99a12 72%,#a96b00 100%);border:1px solid #b87800;box-shadow:0 3px 5px rgba(92,55,0,.24),inset 0 1px 0 rgba(255,255,230,.8);transform:skewX(-10deg)}.gold-mark:after{content:"999.9";position:absolute;left:20px;top:16px;transform:translate(-50%,-50%) skewX(-10deg);font-size:6px;line-height:1;color:#744900;font-weight:900;white-space:nowrap;z-index:3}.gold-mark .bar{display:none}.gold-mark .purity{display:none}.gold-mark-large{width:72px;height:52px}.gold-mark-large:before{left:7px;top:8px;width:58px;height:34px;border-radius:5px 5px 8px 8px}.gold-mark-large:after{left:36px;top:25px;font-size:11px}.gold-mark-large .bar,.gold-mark-large .purity{display:none}.brand-title{font-size:38px;line-height:1.02;font-weight:700;letter-spacing:-1.2px;color:#fff}.brand-sub{display:none}.dot{display:none}.datetime{position:relative;z-index:3;width:205px;background:rgba(255,255,255,.97);border:1px solid #d4e9f9;border-radius:8px;padding:11px 13px;box-shadow:0 3px 12px rgba(0,55,110,.14)}.date{font-size:17px;font-weight:800;text-align:center;color:#0c3d79}.time{font-size:13px;font-weight:700;text-align:center;margin-top:9px;white-space:nowrap;color:#173f70}.hkflag{width:22px;height:16px;vertical-align:-3px;margin-right:7px}
