...
<style>body{font-family:"Lato",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;background:#eef7ff;margin:0;padding:30px}.box{max-width:650px;margin:auto;background:#fff;border:1px solid #cfe5f8;border-radius:18px;padding:25px;box-shadow:0 10px 28px rgba(0,0,0,.08)}h1{margin-top:0}.row{display:grid;grid-template-columns:1fr 150px;gap:12px;margin:12px 0}.row input{padding:12px;border:1px solid #ccc;border-radius:8px;font-size:16px}button{margin-top:15px;padding:12px 22px;border:0;border-radius:9px;background:#1678e8;color:#fff;font-weight:700;font-size:16px;cursor:pointer}.msg{margin-top:15px;font-weight:700}.lightning,.bolt,.zap,.lightning-symbol{display:none!important}
...
<style>
:root{--bg:#eef7ff;--panel:#ffffff;--panel2:#f6fbff;--line:#d7e9f8;--muted:#5f7897;--text:#123f78;--gold:#d99b1f;--gold2:#f4c75b;--green:#16a56d;--red:#ef4d55;--blue:#0869d7;--blue2:#2a91ee;--shadow:0 20px 55px rgba(34,111,178,.12)}
*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:linear-gradient(145deg,#edf7ff 0%,#f9fcff 52%,#e9f5ff 100%);color:var(--text);font-family:"Lato",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif}body{padding:24px 14px 40px;overflow-x:hidden}.page{width:min(1120px,100%);margin:auto}.shell{position:relative;overflow:hidden;border:1px solid #d3e7f8;border-radius:22px;background:linear-gradient(145deg,rgba(255,255,255,.99),rgba(242,249,255,.99));box-shadow:0 18px 50px rgba(45,117,175,.11)}.shell:before{content:"";position:absolute;width:480px;height:480px;right:-220px;top:-240px;border-radius:50%;background:radial-gradient(circle,rgba(24,132,223,.12),transparent 67%);pointer-events:none}.shell:after{content:"";position:absolute;width:400px;height:400px;left:-230px;bottom:-250px;border-radius:50%;background:radial-gradient(circle,rgba(80,174,240,.12),transparent 68%);pointer-events:none}
.header{position:relative;margin:18px;min-height:150px;padding:28px 30px;border:1px solid #c7e1f7;border-radius:22px;background:linear-gradient(135deg,#0b66d2 0%,#1683e7 55%,#58b2f3 100%);display:flex;align-items:center;justify-content:space-between;gap:24px;overflow:hidden;box-shadow:0 12px 30px rgba(24,111,194,.16)}.header:after{content:"999.9";position:absolute;right:-12px;bottom:-44px;font-family:"Lato";font-size:150px;font-weight:700;letter-spacing:-8px;color:rgba(255,255,255,.075);pointer-events:none}.datetime{position:relative;z-index:1}.date{font-family:"Lato";font-size:40px;line-height:1;font-weight:900;letter-spacing:-1.5px;color:#fff}.time{margin-top:10px;display:flex;align-items:center;gap:7px;font-size:13px;font-weight:600;color:rgba(255,255,255,.86);letter-spacing:.3px}.hkflag{width:22px;height:15px;flex:none;border-radius:3px;box-shadow:0 0 0 1px rgba(255,255,255,.24)}
...
.main{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1.25fr) minmax(310px,.75fr);gap:18px;margin:0 18px}.card{border:1px solid #cfe4f7;border-radius:22px;background:linear-gradient(145deg,#ffffff 0%,#f5fbff 100%);box-shadow:0 12px 32px rgba(45,117,175,.10);overflow:hidden}.cardbar{height:76px;padding:0 22px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line);background:linear-gradient(90deg,#eaf6ff,transparent)}.gold-heading{display:flex;align-items:center;gap:13px;font-family:"Lato";font-size:20px;font-weight:900;color:#104a8d}.small-gold{width:52px;height:52px;border-radius:50%;display:grid;place-items:center;border:2px solid #e8bd55;background:radial-gradient(circle at 30% 25%,#fff7c9 0%,#f8d76e 24%,#d99b22 58%,#9a5f08 100%);box-shadow:inset 0 2px 2px rgba(255,255,255,.92),inset 0 -3px 4px rgba(117,67,4,.35),0 7px 16px rgba(180,125,22,.18)}.gold-mark{position:relative;width:40px;height:40px;border-radius:50%;background:radial-gradient(circle at 35% 28%,#fff4b8 0%,#f0c85c 35%,#c98717 72%,#8f5607 100%);border:2px solid rgba(255,244,177,.8);box-shadow:inset 0 1px 2px rgba(255,255,255,.8),inset 0 -2px 3px rgba(96,54,2,.32),0 3px 7px rgba(117,67,4,.2);display:grid;place-items:center;overflow:hidden}.gold-mark:before{content:"";position:absolute;inset:5px;border:1px solid rgba(255,242,167,.78);border-radius:50%;box-shadow:inset 0 0 0 1px rgba(137,82,7,.28)}.gold-mark:after{content:"999.9";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);color:#8a5709;font-family:"Lato",Arial,sans-serif;font-size:8px;font-weight:800;letter-spacing:.2px;text-shadow:0 1px rgba(255,238,160,.8);z-index:2}.trend{width:34px;height:34px;border:1px solid #cce2f7;border-radius:10px;display:grid;place-items:center;color:var(--blue2);font-size:20px;background:#f1f8ff}
.rates-inner{padding:0 12px 12px}.rates-only{padding-top:2px}.thead{display:grid;grid-template-columns:1fr 175px;gap:12px;padding:18px 12px 12px;color:#5f7693;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.65px}.thead div:last-child{text-align:right}.quote-row{display:grid;grid-template-columns:1fr 175px;align-items:center;min-height:76px;padding:9px 12px;margin:7px 0;border:1px solid #e0edf8;border-radius:15px;background:#f7fbff;transition:.2s ease}.quote-row:hover{border-color:#acd2f1;background:#edf7ff;transform:translateY(-1px);box-shadow:0 7px 18px rgba(24,132,223,.08)}.product-wrap{display:flex;align-items:center;gap:12px;min-width:0}.product-icon{width:50px;height:50px;flex:none;display:grid;place-items:center;border-radius:50%;background:linear-gradient(145deg,#fffaf0,#f5d477);border:1px solid rgba(217,155,31,.32);box-shadow:0 6px 14px rgba(180,125,22,.12)}.product-icon .gold-mark{transform:scale(.9)}.product{min-width:0;color:#154b86;font-size:14px;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.prices{display:flex;align-items:center;justify-content:flex-end;gap:8px;font-family:"Lato";font-size:24px;font-weight:900;letter-spacing:-.6px;color:#083f7d;font-variant-numeric:tabular-nums}.rate-arrow{font-family:Arial;font-size:13px;font-weight:800}.rate-arrow.up{color:var(--green)}.rate-arrow.down{color:var(--red)}.same{color:#7d98b5}
.rules-title{height:76px;padding:0 22px;display:flex;align-items:center;gap:12px;border-bottom:1px solid var(--line);font-family:"Lato";font-size:20px;font-weight:900;color:#104a8d}.info{width:36px;height:36px;display:grid;place-items:center;border-radius:11px;border:1px solid #b9daf4;background:#edf7ff;color:#0d70c7;font:700 19px Georgia}.rules-body{padding:8px 20px 12px}.rule{display:grid;grid-template-columns:40px 1fr;gap:12px;padding:17px 0;border-bottom:1px solid var(--line)}.rule:last-child{border-bottom:0}.rule-num{width:36px;height:36px;display:grid;place-items:center;border-radius:10px;background:#edf7ff;border:1px solid #c6e2f7;color:#0b69b8;font-size:11px;font-weight:800}.rule p{margin:1px 0 0;color:#5f7897;font-size:12px;line-height:1.62}.rule b{color:#154b86;font-weight:700}.bottom-art{height:100px;position:relative;overflow:hidden}.bottom-art:before{content:"";position:absolute;left:5%;right:5%;top:55px;height:1px;background:linear-gradient(90deg,transparent,#b8d8f2,transparent)}
