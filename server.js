...
@media(max-width:390px){.date{font-size:24px}.market-status{font-size:9px}.thead,.quote-row{grid-template-columns:1fr 96px 86px;gap:5px}.product{font-size:11px}.prices{font-size:18px}.hkd-rate{font-size:14px}.rules-title{font-size:16px}}
...
<main class="main"><section class="card"><div class="rates-inner rates-only"><div class="thead"><div>PRODUCT (GOLD - 999.9)</div><div>USD RATE / GRAM</div><div>HKD RATE</div></div><div id="rows"></div></div></section>
