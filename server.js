...
*{box-sizing:border-box}html,body{margin:0;padding:0}body{min-height:100vh;background:linear-gradient(180deg,#f8fbff 0%,#eef7ff 100%);font-family:Arial,Helvetica,sans-serif;color:var(--navy);padding:10px 8px 22px}.dashboard{width:min(980px,100%);margin:0 auto}
...
@media(max-width:480px){.date-card{min-height:54px;font-size:29px}.time-line{font-size:13px;height:29px}.main-grid{gap:9px}.rate-wrap{padding:8px}.rate-head,.quote-row{grid-template-columns:minmax(0,1fr) minmax(120px,.78fr)}.rate-head{min-height:36px;font-size:11px;padding:0 9px}.quote-row{min-height:55px;padding:6px 9px}.product{font-size:13px}.prices{font-size:20px;gap:6px}.rule{grid-template-columns:34px 1fr;gap:8px;padding:8px 2px}.num{width:32px;height:32px;font-size:11px}.rule p{font-size:11.5px;line-height:1.46}}
...
<section class="card"><div class="card-head"><span class="num" style="background:rgba(255,255,255,.2);box-shadow:none;width:32px;height:32px">i</span><span>Booking Rules / Notes</span></div><div class="rules">
