...
*{box-sizing:border-box}html,body{margin:0;padding:0}body{min-height:100vh;background:radial-gradient(circle at 12% 0%,#fff 0,#f7fafc 35%,#eef4f8 100%);color:var(--ink);font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;padding:20px 12px 28px;-webkit-font-smoothing:antialiased}.page{width:min(1120px,100%);margin:auto}.shell{position:relative;overflow:hidden;background:rgba(255,255,255,.82);border:1px solid #dce6ee;border-radius:24px;box-shadow:0 22px 70px rgba(35,69,100,.10);padding:14px}.shell:before{content:"";position:absolute;inset:0;background:linear-gradient(125deg,rgba(255,255,255,.72),rgba(231,243,252,.36) 54%,rgba(255,255,255,.7));pointer-events:none}
/* header */
.header{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:20px;min-height:118px;padding:20px 22px;border-radius:19px;border:1px solid #cfe4f4;background:linear-gradient(120deg,#ffffff 0%,#f7fbff 46%,#e7f4ff 100%);box-shadow:0 9px 26px rgba(27,111,178,.08);overflow:hidden}.header:after{content:"";position:absolute;right:-7%;top:-72px;width:62%;height:210px;border-radius:50%;border:1px solid rgba(91,171,232,.25);box-shadow:-38px 28px 0 -1px rgba(255,255,255,.75),-78px 57px 0 -1px rgba(111,185,238,.18);transform:rotate(-8deg)}.brand{position:relative;z-index:2;display:flex;align-items:center;gap:18px;min-width:0}.brand-icon{width:74px;height:74px;border-radius:20px;display:grid;place-items:center;background:linear-gradient(145deg,#fff9df,#fff2c5);border:1px solid #f0d88e;box-shadow:inset 0 1px #fff,0 8px 18px rgba(188,133,20,.12);flex:none}.gold-logo{position:relative;width:50px;height:43px}.gold-logo .bar{position:absolute;display:block;border:1px solid rgba(132,83,0,.45);background:linear-gradient(145deg,#fff7b4 0%,#f9cf42 28%,#db9409 66%,#a96700 100%);box-shadow:0 3px 4px rgba(121,75,0,.18);border-radius:4px;transform:skewX(-14deg)}.gold-logo .a{width:34px;height:18px;left:1px;top:22px}.gold-logo .b{width:34px;height:18px;left:14px;top:10px}.gold-logo .c{width:27px;height:15px;left:25px;top:27px}.gold-logo .purity{position:absolute;z-index:4;left:7px;top:24px;font-size:6px;font-weight:900;letter-spacing:.2px;color:#6e4300;text-shadow:0 1px rgba(255,240,150,.5)}.brand-title{margin:0;color:#0b3f79;font-size:clamp(27px,3.6vw,40px);line-height:1;font-weight:850;letter-spacing:-1.4px}.brand-sub{margin-top:9px;color:#55748f;font-size:13px;font-weight:650;letter-spacing:.15px}.brand-sub .dot{display:inline-block;width:4px;height:4px;margin:0 8px 2px;border-radius:50%;background:var(--gold)}
...
/* main */
.main{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1.42fr) minmax(310px,.86fr);gap:14px;margin-top:14px}.card{min-width:0;background:rgba(255,255,255,.93);border:1px solid #d8e6f0;border-radius:18px;box-shadow:var(--shadow);overflow:hidden}.rate-card{padding:0 10px 10px}.card-head{height:68px;margin:0 -1px 0;display:flex;align-items:center;justify-content:space-between;padding:0 17px;border-radius:17px 17px 12px 12px;background:linear-gradient(110deg,#0f70df,#2c91ec 58%,#62baf3);color:#fff;box-shadow:inset 0 1px rgba(255,255,255,.28)}.head-left{display:flex;align-items:center;gap:12px}.head-icon{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,.18);border:1px solid rgba(255,255,255,.28);box-shadow:inset 0 1px rgba(255,255,255,.25)}.head-icon .gold-logo{transform:scale(.72)}.head-title{font-size:19px;font-weight:850;letter-spacing:-.25px}.live-pill{padding:6px 10px;border-radius:999px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.28);font-size:10px;font-weight:850;letter-spacing:.6px;text-transform:uppercase}.live-dot{display:inline-block;width:6px;height:6px;margin-right:6px;border-radius:50%;background:#b9ffd8;box-shadow:0 0 0 3px rgba(185,255,216,.14)}.trend{width:64px;height:32px;opacity:.9}.trend svg{width:100%;height:100%}
...
<header class="header"><div class="brand"><div class="brand-icon"><div class="gold-logo" aria-hidden="true"><span class="bar a"></span><span class="bar b"></span><span class="bar c"></span><span class="purity">999.9</span></div></div><div><div class="brand-title">Live Gold Rates</div><div class="brand-sub">Market Rates <span class="dot"></span> Your Trusted Source</div></div></div><div class="datetime"><div id="date" class="date">--</div><div class="time"><svg class="hkflag" viewBox="0 0 24 17" aria-label="Hong Kong"><rect width="24" height="17" rx="2" fill="#DE2910"/><path d="M8.4 4.7c-1.9-1-3.7.5-3 2.2.45 1.1 1.7 1.5 2.8.8-1.15.15-1.85-.7-1.55-1.45.28-.67 1.08-.94 1.75-.86Z" fill="#fff"/><circle cx="9.2" cy="5.5" r=".6" fill="#fff"/><circle cx="7.4" cy="4.2" r=".6" fill="#fff"/><circle cx="6.2" cy="6.7" r=".6" fill="#fff"/><circle cx="8.8" cy="7.8" r=".6" fill="#fff"/></svg><span id="time">--:--:-- -- HKT</span></div></div></header>
<main class="main"><section class="card rate-card"><div class="card-head"><div class="head-left"><div class="head-icon"><div class="gold-logo" aria-hidden="true"><span class="bar a"></span><span class="bar b"></span><span class="bar c"></span><span class="purity">999.9</span></div></div><div class="head-title">Gold (999.9)</div><div class="live-pill"><span class="live-dot"></span>Live</div></div><div class="trend" aria-hidden="true"><svg viewBox="0 0 64 32" fill="none"><path d="M2 26 12 20 20 23 30 12 39 17 50 6 61 9" stroke="rgba(255,255,255,.92)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="61" cy="9" r="2.4" fill="#fff"/></svg></div></div><div class="rates"><div class="thead"><div>Product</div><div>USD Rate / Gram</div></div><div id="rows"></div></div></section>
