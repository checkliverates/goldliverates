...
@media(max-width:390px){.date{font-size:24px}.market-status{font-size:9px}.thead,.quote-row{grid-template-columns:1fr 96px 86px;gap:5px}.product{font-size:11px}.prices{font-size:18px}.hkd-rate{font-size:15px}.rules-title{font-size:16px}}
