...
<style>
*{box-sizing:border-box}html,body{margin:0;padding:0}body{min-height:100vh;background:#eef7ff;font-family:"Trebuchet MS","Segoe UI",Arial,sans-serif;color:#103e70;padding:20px}.wrap{width:min(1100px,100%);margin:auto}.top{background:linear-gradient(135deg,#0d6fd7 0%,#238fe7 55%,#73c9f5 100%);border-radius:26px;padding:17px 20px;color:#fff;box-shadow:0 16px 34px rgba(21,102,177,.22);display:flex;align-items:center;justify-content:space-between;gap:20px}.brand{display:flex;align-items:center;gap:15px}.gold-icon{width:68px;height:60px;border-radius:18px;background:linear-gradient(145deg,#fff8d9,#e6b72f);display:grid;place-items:center;font-size:38px;box-shadow:0 7px 17px rgba(0,55,115,.2)}.title{font-family:Georgia,serif;font-size:clamp(29px,4vw,42px);font-weight:900;letter-spacing:-1px}.sub{font-size:13px;opacity:.88;margin-top:3px}.clock{background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.35);border-radius:16px;padding:10px 15px;min-width:215px}.date{font-size:18px;font-weight:900}.time{margin-top:5px;font-size:13px;font-weight:800}.hk-flag{width:20px;height:14px;vertical-align:-2px}.layout{display:grid;grid-template-columns:1.7fr .9fr;gap:18px;margin-top:18px}.rates-card,.rules{background:#fff;border-radius:24px;border:1px solid #d6e9f8;box-shadow:0 13px 28px rgba(35,94,139,.12);overflow:hidden}.rates-top{padding:14px 18px;background:linear-gradient(90deg,#0870da,#55b6f1);color:#fff;display:flex;align-items:center;justify-content:space-between;font-size:20px;font-weight:900}.rates-top:after{content:"↗";font-size:27px;opacity:.8}.rates{padding:15px}.thead{display:grid;grid-template-columns:1fr 165px;padding:12px 15px;border-radius:12px;background:#edf7ff;color:#184b7e;font-size:13px;font-weight:900}.thead div:last-child{text-align:right}.quote-row{display:grid;grid-template-columns:1fr 165px;align-items:center;min-height:76px;padding:10px 15px;border-bottom:1px solid #e6f0f8}.quote-row:last-child{border-bottom:0}.product{font-size:16px;font-weight:900;color:#143f70}.prices{display:flex;justify-content:flex-end;align-items:center;gap:9px;color:#0b78de;font-size:28px;font-weight:900}.rate-arrow{font-size:16px}.up{color:#10aa6b}.down{color:#e84848}.rules-head{padding:15px 17px;background:#f0f8ff;display:flex;align-items:center;gap:10px;color:#123f70;font-size:19px;font-weight:900}.info{width:39px;height:39px;border-radius:13px;display:grid;place-items:center;background:#1779dc;color:#fff;font-size:22px}.rules-body{padding:8px 17px}.rule{display:flex;gap:12px;padding:14px 0;border-bottom:1px solid #e2eef8}.rule:last-child{border-bottom:0}.rule-num{flex:0 0 38px;width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(145deg,#3ba8f0,#0c6fd4);color:#fff;font-weight:900;font-size:13px}.rule p{margin:0;font-size:12px;line-height:1.55;color:#4b6c8d}.rule b{color:#153f6d}.foot{text-align:center;margin-top:12px;color:#6e8ba8;font-size:11px}@media(max-width:780px){body{padding:10px}.layout{grid-template-columns:1fr}.top{padding:15px}.clock{min-width:205px}}@media(max-width:520px){.top{flex-direction:column}.brand{justify-content:center}.clock{width:100%;text-align:center}.thead,.quote-row{grid-template-columns:1fr 140px}.product{font-size:14px}.prices{font-size:22px}.rates-top{font-size:17px}.rules-head{font-size:16px}.rule p{font-size:12px}}
</style>
</head><body><div class="wrap"><header class="top"><div class="brand"><div class="gold-icon">🪙</div><div><div class="title">Live Gold Rates</div><div class="sub">Market Rates&nbsp;&nbsp;•&nbsp;&nbsp; Your Trusted Source</div></div></div><div class="clock"><div id="date" class="date">--</div><div class="time"><svg class="hk-flag" viewBox="0 0 24 17"><rect width="24" height="17" rx="2" fill="#DE2910"/><path d="M8.25 5.1c-1.8-1.2-4 .1-3.35 2.2.45 1.45 2.2 2.05 3.35 1.02-1.5.4-2.55-.85-2.2-1.9.3-.85 1.35-1.25 2.2-1.32Z" fill="#fff"/></svg> <span id="time">--:--:-- -- HKT</span></div></div></header><main class="layout"><section class="rates-card"><div class="rates-top"><span>🪙&nbsp; Gold (999.9)</span></div><div class="rates"><div class="thead"><div>Product</div><div>USD Rate / Gram</div></div><div id="rows"></div></div></section><section class="rules"><div class="rules-head"><span class="info">i</span><span>Booking Rules / Notes</span></div><div class="rules-body">
