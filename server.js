...
.rates-inner{padding:0 12px 12px}.rates-only{padding-top:2px}.thead{display:grid;grid-template-columns:1fr 175px;gap:12px;padding:18px 12px 12px;color:#5f7693;font-size:11.5px;font-weight:700;text-transform:uppercase;letter-spacing:.65px}.thead div:last-child{text-align:right}.quote-row{display:grid;grid-template-columns:1fr 175px;align-items:center;min-height:76px;padding:9px 12px;margin:7px 0;border:1px solid #e0edf8;border-radius:15px;background:#f8fbfe;transition:.2s ease}.quote-row:hover{border-color:#acd2f1;background:#f0f8ff;transform:translateY(-1px);box-shadow:0 7px 18px rgba(24,132,223,.08)}.product-wrap{display:flex;align-items:center;gap:12px;min-width:0}.product-icon{width:50px;height:50px;flex:none;display:grid;place-items:center;border-radius:50%;background:linear-gradient(145deg,#fffaf0,#f5d477);border:1px solid rgba(217,155,31,.32);box-shadow:0 6px 14px rgba(180,125,22,.12)}.product-icon .gold-mark{transform:scale(.9)}.product{min-width:0;color:#164f8e;font-size:15px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.prices{display:flex;align-items:center;justify-content:flex-end;gap:8px;font-family:Arial,Helvetica,sans-serif;font-size:24px;font-weight:700;letter-spacing:-.6px;color:#083f7d;font-variant-numeric:tabular-nums lining-nums}.rate-arrow{font-family:Arial;font-size:13px;font-weight:800}.rate-arrow.up{color:var(--green)}.rate-arrow.down{color:var(--red)}.same{color:#7d98b5}
.rules-title{height:76px;padding:0 22px;display:flex;align-items:center;gap:12px;border-bottom:1px solid var(--line);font-family:Arial,Helvetica,sans-serif;font-size:21px;font-weight:700;color:#0a4688}.info{width:36px;height:36px;display:grid;place-items:center;border-radius:11px;border:1px solid #b9daf4;background:#edf7ff;color:#0d70c7;font:700 19px Georgia}.rules-body{padding:8px 20px 12px}.rule{display:grid;grid-template-columns:40px 1fr;gap:12px;padding:17px 0;border-bottom:1px solid var(--line)}.rule:last-child{border-bottom:0}.rule-num{width:36px;height:36px;display:grid;place-items:center;border-radius:10px;background:#edf7ff;border:1px solid #c6e2f7;color:#0b69b8;font-size:11.5px;font-weight:800}.rule p{margin:1px 0 0;color:#5f7897;font-size:12.5px;line-height:1.62}.rule b{color:#164f8e;font-weight:700}.bottom-art{height:100px;position:relative;overflow:hidden}.bottom-art:before{content:"";position:absolute;left:5%;right:5%;top:55px;height:1px;background:linear-gradient(90deg,transparent,#b8d8f2,transparent)}
