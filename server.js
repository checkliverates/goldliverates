...
/* DESIGN 02 - Navy Cards */
:root{--blue:#1559c8;--blue2:#5aaeff;--ink:#102f61;--gold:#d8a62a;--line:#d9e8f8;--paper:#f5f9ff}
body{font-family:"Arial Rounded MT Bold","Segoe UI",Arial,sans-serif;background:linear-gradient(135deg,#f8fbff 0%,#edf5ff 50%,#e3f0ff 100%);padding:16px 12px 28px}
.hero{border:0;border-radius:22px;padding:17px 20px;background:linear-gradient(120deg,#ffffff 0%,#f3f9ff 55%,#d9ecff 100%);box-shadow:0 15px 32px rgba(17,74,139,.14);position:relative}.hero:after{content:"";position:absolute;right:-40px;bottom:-85px;width:430px;height:190px;border-radius:50%;border:2px solid rgba(42,145,235,.15);transform:rotate(-10deg);pointer-events:none}
.brand{gap:16px}.brand-mark{width:84px;height:72px;font-size:0;border-radius:20px;background:linear-gradient(145deg,#fff8dc,#e5b12c);box-shadow:0 9px 20px rgba(198,150,23,.20)}.brand-mark:after{content:"🪙";font-size:45px}.hero-title{font-size:clamp(30px,4vw,42px);font-weight:900;letter-spacing:-1.5px;color:#0b3e7d}.eyebrow{letter-spacing:1.5px;color:#2d73ba}.tagline{font-size:14px;color:#55799e}.hero-right{min-width:220px;border-radius:16px;background:rgba(255,255,255,.86);border:1px solid #c9e1f7;box-shadow:0 7px 18px rgba(25,92,148,.10)}
.content-grid{gap:16px;margin-top:16px}.panel{border:0;border-radius:20px;box-shadow:0 12px 28px rgba(21,76,129,.12);background:rgba(255,255,255,.94)}.panel-head{padding:13px 16px;background:linear-gradient(110deg,#0e65d4,#3daaf1);border-radius:20px 20px 11px 11px;font-size:19px}.panel-icon{background:#fff;color:#176bd2;border:0;box-shadow:0 5px 12px rgba(0,0,0,.08)}.panel:first-child .panel-icon{font-size:0}.panel:first-child .panel-icon:after{content:"🪙";font-size:21px}.rates-inner{padding:11px 13px 13px}.rate-head{border:0;border-radius:10px;background:#edf7ff;padding:11px 14px;color:#17477a;font-size:13px}.rate-body{border:0}.quote-row{min-height:70px;border-bottom:1px solid #e4eef8!important;padding:10px 14px}.quote-row:nth-child(even){background:#fbfdff}.product{font-size:15.5px;color:#143f72;padding-left:34px}.prices{font-size:26px;color:#0875da}.rules-body{padding:10px 14px 14px}.rule{padding:12px 5px;border-bottom:1px solid #e2edf8}.rule-num{background:#1678e4;box-shadow:0 4px 11px rgba(22,120,228,.18)}.rule p{font-size:12.5px;line-height:1.52}.footer-dot{background:#1678e4;box-shadow:0 0 0 4px rgba(22,120,228,.10)}
