...
/* DESIGN VARIANT 03 — Bold Luxury */
.brand-title{font-family:Arial,Helvetica,sans-serif;font-size:32px;font-weight:900;letter-spacing:-1.5px}
.brand-sub,.datetime,.product,.thead,.rules-title,.rule p,.prices{font-family:Arial,Helvetica,sans-serif}
.gold-mark{filter:drop-shadow(0 2px 2px rgba(143,91,0,.15))}
.gold-mark .bar{background:linear-gradient(155deg,#fff9c9 0%,#ffd52f 22%,#f0ae00 47%,#cc7600 72%,#ffea73 100%);border:1px solid rgba(145,88,0,.46);box-shadow:inset 0 1px rgba(255,255,255,.55),0 2px 4px rgba(125,76,0,.20)}
.gold-mark .bar-a{transform:skewX(-16deg) rotate(-2deg)}
.gold-mark .bar-b{transform:skewX(-16deg) rotate(2deg)}
.gold-mark .bar-c{transform:skewX(-16deg) rotate(-1deg)}
.gold-mark .purity{font-family:Arial,sans-serif;font-weight:900;color:#704000}
