...
*{box-sizing:border-box}html,body{margin:0;padding:0}body{min-height:100vh;background:linear-gradient(180deg,#fbfcfe 0,#f3f6fa 100%);font-family:"Trebuchet MS","Segoe UI",Arial,sans-serif;color:var(--ink);padding:12px 11px 26px}.dashboard{width:min(900px,100%);margin:auto}
/* ===== HEADER ===== */
.hero{position:relative;overflow:hidden;background:linear-gradient(135deg,#ffffff 0,#ffffff 72%,#fffaf0 100%);border:1px solid var(--gold);border-radius:18px;padding:15px 18px;box-shadow:0 10px 28px rgba(25,35,50,.09)}
.hero:after{content:"";position:absolute;right:-80px;top:-105px;width:230px;height:230px;border-radius:50%;background:radial-gradient(circle,rgba(225,182,61,.18),transparent 68%);pointer-events:none}.hero-inner{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:20px}.brand{display:flex;align-items:center;gap:13px}.brand-mark{width:38px;height:38px;border-radius:11px;background:linear-gradient(145deg,var(--gold2),var(--gold));display:grid;place-items:center;color:#fff;font-size:18px;box-shadow:0 7px 17px rgba(199,154,24,.22)}.eyebrow{font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);font-weight:800}.hero-title{font-size:clamp(18px,3.0vw,25px);font-weight:900;margin-top:3px}.hero-right{text-align:right}.date{font-size:clamp(20px,3.4vw,30px);font-weight:900;letter-spacing:-.8px}.time-row{display:flex;justify-content:flex-end;align-items:center;gap:7px;margin-top:4px;font-size:clamp(13px,2vw,16px);font-weight:800;color:#20242a}.hk-flag{width:20px;height:14px;display:inline-flex;flex:0 0 auto}.hk-flag svg{width:20px;height:14px;display:block}
/* ===== RATES ===== */
.rate-card{margin-top:14px;border-radius:17px;overflow:hidden;background:#fff;border:1px solid #e1e4e8;box-shadow:0 12px 30px rgba(25,35,50,.10)}.rate-head{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(220px,.85fr);background:linear-gradient(135deg,var(--gold2),var(--gold));color:#fff;padding:13px 17px;font-size:clamp(15px,2.3vw,20px);font-weight:900}.rate-head .right{text-align:right}.rate-body{background:#fff}.quote-row{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(220px,.85fr);align-items:center;min-height:62px;padding:13px 17px;background:#fff}.quote-row+.quote-row{border-top:1px solid var(--line)}.quote-row:nth-child(even){background:#fcfdff}.product{font-size:clamp(15px,2.25vw,19px);font-weight:800;line-height:1.3;color:#15181d}.prices{text-align:right;font-size:clamp(21px,3.25vw,30px);font-weight:900;white-space:nowrap;letter-spacing:-.8px;color:var(--blue);display:flex;align-items:center;justify-content:flex-end;gap:7px}.rate-arrow{font-size:clamp(16px,2.25vw,21px);font-weight:900;line-height:1}.rate-arrow.up{color:var(--up)}.rate-arrow.down{color:var(--down)}.rate-arrow.same{color:#a3aab4;font-size:18px}
/* ===== NOTES ===== */
.notes{margin-top:17px}.section-title{display:flex;align-items:center;gap:9px;margin-bottom:9px}.section-line{height:1px;flex:1;background:linear-gradient(90deg,transparent,var(--gold))}.section-line.r{background:linear-gradient(90deg,var(--gold),transparent)}.section-pill{display:flex;align-items:center;gap:8px;background:linear-gradient(135deg,var(--gold2),var(--gold));color:#fff;border-radius:999px;padding:7px 14px;font-size:14px;font-weight:900;white-space:nowrap;box-shadow:0 6px 14px rgba(199,154,24,.18)}.notes-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.note-card{position:relative;background:#fff;border:1px solid #e0e4e9;border-radius:13px;padding:13px 13px 13px 42px;box-shadow:0 7px 20px rgba(25,35,50,.055);min-height:110px}.note-card:before{content:"";position:absolute;left:0;top:10px;bottom:10px;width:3px;border-radius:0 5px 5px 0;background:linear-gradient(180deg,var(--gold2),var(--gold))}.note-num{position:absolute;left:12px;top:12px;width:23px;height:23px;border-radius:7px;background:#fff7dd;border:1px solid #e5c86b;color:#9a7310;display:grid;place-items:center;font-size:10px;font-weight:900}.note-card p{margin:0;font-size:13px;line-height:1.5;color:#30343a}.note-card b{color:#111}.footer{margin-top:15px;display:flex;justify-content:center;align-items:center;gap:8px;color:#7b838d;font-size:12px}.footer-dot{width:8px;height:8px;border-radius:50%;background:var(--gold);box-shadow:0 0 0 4px rgba(199,154,24,.11)}
@media(max-width:700px){body{padding:8px 7px 20px}.hero{border-radius:16px;padding:13px 13px}.hero-inner{flex-direction:column;align-items:flex-start;gap:9px}.brand-mark{width:34px;height:34px;border-radius:10px;font-size:16px}.hero-right{text-align:left;width:100%}.time-row{justify-content:flex-start}.rate-card{margin-top:10px;border-radius:15px}.rate-head,.quote-row{grid-template-columns:minmax(0,1fr) minmax(150px,.9fr)}.rate-head{padding:11px 12px;font-size:15px}.quote-row{min-height:58px;padding:11px 12px}.product{font-size:14px}.prices{font-size:21px;gap:6px}.notes{margin-top:15px}.notes-grid{grid-template-columns:1fr}.note-card{min-height:auto;padding:13px 12px 13px 43px}}
@media(max-width:400px){.hero-title{font-size:18px}.date{font-size:23px}.time-row{font-size:13px}.rate-head,.quote-row{grid-template-columns:minmax(0,1fr) minmax(105px,.9fr)}.rate-head{font-size:13px;padding:10px 10px}.quote-row{padding:10px}.product{font-size:13px}.prices{font-size:19px;gap:5px}.rate-arrow{font-size:16px}.section-pill{font-size:13px;padding:7px 12px}.note-card p{font-size:12px}}
