...
/* DESIGN VARIANT 04 — Clean Corporate */
.brand-title{font-family:Verdana,Arial,sans-serif;font-size:30px;font-weight:900;letter-spacing:-1.2px}
.brand-sub,.datetime,.product,.thead,.rules-title,.rule p,.prices{font-family:Verdana,Arial,sans-serif}
.gold-mark .bar{background:linear-gradient(140deg,#fff9c8 0%,#f7d24b 30%,#d99508 66%,#b96c00 100%);border:1px solid rgba(157,99,0,.38);box-shadow:0 2px 4px rgba(117,71,0,.16)}
.gold-mark .bar-a,.gold-mark .bar-b,.gold-mark .bar-c{border-radius:2px}
.gold-mark .purity{font-family:Verdana,Arial,sans-serif;font-weight:900;color:#744700}
