...
.brand-title{font-family:"Segoe UI",Arial,sans-serif;font-size:32px;font-weight:800;letter-spacing:-1px}
.brand-sub,.datetime,.product,.thead,.rules-title,.rule p,.prices{font-family:"Segoe UI",Arial,sans-serif}
...
.gold-mark .purity{font-family:"Segoe UI",Arial,sans-serif;font-weight:900;color:#754700}
