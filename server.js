...
function page() {
return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#0b67c2"><title>Live Gold Rates</title><link rel="icon" href="data:,"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700;900&display=swap" rel="stylesheet">
<style>
...
*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:linear-gradient(145deg,#eaf5ff 0%,#f7fbff 48%,#e3f1ff 100%);color:var(--text);font-family:"Lato",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif}body{padding:24px 14px 40px;overflow-x:hidden}.page{width:min(1120px,100%);margin:auto}.shell{position:relative;overflow:hidden;border:1px solid #cfe4f7;border-radius:28px;background:linear-gradient(145deg,rgba(255,255,255,.99),rgba(242,249,255,.99));box-shadow:var(--shadow)}.shell:before{content:"";position:absolute;width:480px;height:480px;right:-220px;top:-240px;border-radius:50%;background:radial-gradient(circle,rgba(24,132,223,.12),transparent 67%);pointer-events:none}.shell:after{content:"";position:absolute;width:400px;height:400px;left:-230px;bottom:-250px;border-radius:50%;background:radial-gradient(circle,rgba(80,174,240,.12),transparent 68%);pointer-events:none}
.header-gold-coin{position:relative;z-index:2;width:112px;height:112px;flex:none;filter:drop-shadow(0 9px 15px rgba(0,0,0,.18))}.header-gold-coin svg{display:block;width:100%;height:100%}.header{position:relative;margin:18px;min-height:150px;padding:28px 30px;border:1px solid #c7e1f7;border-radius:22px;background:linear-gradient(135deg,#0752a0 0%,#0b69bf 52%,#1a8ce2 100%);display:flex;align-items:center;justify-content:flex-start;gap:22px;overflow:hidden;box-shadow:0 14px 34px rgba(10,92,166,.18)}.header:after{content:"999.9";position:absolute;right:-12px;bottom:-44px;font-family:"Lato";font-size:150px;font-weight:700;letter-spacing:-8px;color:rgba(255,255,255,.075);pointer-events:none}.datetime{position:relative;z-index:1}.date{font-family:"Lato";font-size:40px;line-height:1;font-weight:700;letter-spacing:-1.5px;color:#fff}.time{margin-top:10px;display:flex;align-items:center;gap:7px;font-size:13px;font-weight:600;color:rgba(255,255,255,.86);letter-spacing:.3px}.hkflag{width:22px;height:15px;flex:none;border-radius:3px;box-shadow:0 0 0 1px rgba(255,255,255,.24)}
...
@media(max-width:600px){body{padding:7px 5px 18px}.header-gold-coin{width:70px;height:70px}.shell{border-radius:19px}.header{margin:8px;min-height:108px;padding:18px 17px;border-radius:16px}.date{font-size:27px;letter-spacing:-1px}.time{font-size:10px;margin-top:7px}.hkflag{width:19px;height:13px}.market-status{right:14px;bottom:14px;padding:7px 10px;font-size:10px}.status-dot{width:6px;height:6px}.main{margin:0 8px;gap:10px}.card{border-radius:16px}.cardbar{height:62px;padding:0 13px}.gold-heading{font-size:17px;gap:9px;color:#064b9b}.small-gold{width:43px;height:43px;border-radius:50%}.trend{width:30px;height:30px}.rates-inner{padding:0 7px 7px}.thead{grid-template-columns:1fr 128px;padding:13px 8px 9px;font-size:8.5px;letter-spacing:.35px}.quote-row{grid-template-columns:1fr 128px;min-height:64px;padding:7px 8px;margin:5px 0;border-radius:12px}.product-wrap{gap:8px}.product-icon{width:76px;height:76px;border-radius:50%}.product-icon .gold-mark:before{inset:12px}.product-icon .gold-mark:after{font-size:11px}.product{font-size:12px}.prices{font-size:19px;gap:6px}.rate-arrow{font-size:11px}.rules-title{height:62px;padding:0 14px;font-size:17px;gap:9px;color:#064b9b}.info{width:31px;height:31px;font-size:17px}.rules-body{padding:3px 13px 8px}.rule{grid-template-columns:34px 1fr;gap:9px;padding:12px 0}.rule-num{width:32px;height:32px;font-size:10px}.rule p{font-size:10.5px;line-height:1.55}.bottom-art{height:35px}}
@media(max-width:390px){.header-gold-coin{width:62px;height:62px}.date{font-size:24px}.market-status{font-size:9px}.thead,.quote-row{grid-template-columns:1fr 116px}.product{font-size:11px}.prices{font-size:18px}.rules-title{font-size:16px}}
</style></head><body><div class="page"><div class="shell">
<header class="header"><div class="header-gold-coin" aria-hidden="true"><svg viewBox="0 0 120 120" role="img" aria-label="Gold 999.9 coin"><defs><radialGradient id="coinG" cx="32%" cy="24%"><stop offset="0" stop-color="#fff9d7"/><stop offset=".24" stop-color="#f7d96a"/><stop offset=".58" stop-color="#d99b1f"/><stop offset=".84" stop-color="#a9670a"/><stop offset="1" stop-color="#754006"/></radialGradient></defs><circle cx="60" cy="60" r="56" fill="url(#coinG)" stroke="#f6d873" stroke-width="3"/><circle cx="60" cy="60" r="46" fill="none" stroke="#fff1a6" stroke-width="1.5" opacity=".9"/><circle cx="60" cy="60" r="41" fill="none" stroke="#8b5609" stroke-width="1" opacity=".45"/><text x="60" y="55" text-anchor="middle" fill="#7d4b07" font-family="Lato,Arial,sans-serif" font-size="13" font-weight="900">999.9</text><text x="60" y="72" text-anchor="middle" fill="#8c5708" font-family="Lato,Arial,sans-serif" font-size="7" font-weight="700" letter-spacing="1">FINE GOLD</text></svg></div><div class="datetime"><div id="date" class="date">--</div><div class="time"><svg class="hkflag" viewBox="0 0 24 17"><rect width="24" height="17" rx="2" fill="#DE2910"/><path d="M8.4 4.7c-1.9-1-3.7.5-3 2.2.45 1.1 1.7 1.5 2.8.8-1.15.15-1.85-.7-1.55-1.45.28-.67 1.08-.94 1.75-.86Z" fill="#fff"/><circle cx="9.2" cy="5.5" r=".6" fill="#fff"/><circle cx="7.4" cy="4.2" r=".6" fill="#fff"/><circle cx="6.2" cy="6.7" r=".6" fill="#fff"/><circle cx="8.8" cy="7.8" r=".6" fill="#fff"/></svg><span id="time">--:--:-- -- HKT</span></div></div><div class="market-status"><span class="status-dot"></span><span>LIVE MARKET</span></div></header>
