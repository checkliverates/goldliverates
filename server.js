...
/* DESIGN 04 - Modern Blue */
:root{--blue:#126ed1;--blue2:#38aef2;--ink:#123c6c;--gold:#d3a42b;--line:#d7e8f6}
body{font-family:"Inter","Segoe UI",Arial,sans-serif;background:linear-gradient(180deg,#f9fcff 0%,#edf6fd 100%);padding:12px 10px 24px}
.hero{border:1px solid #d1e7f8;border-radius:18px;padding:14px 18px;background:#fff;box-shadow:0 10px 26px rgba(28,93,137,.10)}
.brand{gap:14px}.brand-mark{width:78px;height:66px;border-radius:18px;font-size:0;background:linear-gradient(145deg,#fff9e6,#e1b02b);box-shadow:0 7px 15px rgba(202,157,31,.18)}.brand-mark:after{content:"🪙";font-size:42px}.hero-title{font-size:clamp(28px,4vw,40px);font-weight:900;letter-spacing:-1px;color:#0d427d}.tagline{font-size:13px}.hero-right{min-width:210px;padding:10px 14px;border-radius:14px;background:#f8fcff;border:1px solid #d3e7f7}.date{font-size:18px}.time-row{font-size:13px}
.content-grid{gap:13px;margin-top:13px}.panel{border-radius:17px;border:1px solid #d6e8f7;box-shadow:0 9px 24px rgba(25,87,133,.09)}.panel-head{padding:11px 14px;background:linear-gradient(100deg,#0d6ed4,#43b0ee);font-size:18px;border-radius:17px 17px 10px 10px}.panel-icon{width:36px;height:36px;background:rgba(255,255,255,.28);font-size:18px}.panel:first-child .panel-icon{font-size:0}.panel:first-child .panel-icon:after{content:"🪙";font-size:20px}.rates-inner{padding:9px 11px 11px}.rate-head{border:0;border-radius:9px;background:#eef8ff;padding:10px 13px;font-size:12px}.rate-body{border:0}.quote-row{min-height:65px;padding:9px 13px;border-bottom:1px solid #e3eef7!important}.product{font-size:15px;padding-left:30px}.prices{font-size:24px;color:#0875d8;gap:7px}.rate-arrow{font-size:15px}.rules-body{padding:8px 11px 11px}.rule{padding:10px 4px}.rule-num{width:36px;height:36px;background:linear-gradient(145deg,#43aaf1,#126dd3)}.rule p{font-size:12px;line-height:1.48}.footer{margin-top:11px;font-size:11px}
