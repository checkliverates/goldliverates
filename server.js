...
*{box-sizing:border-box}html,body{margin:0;padding:0}body{min-height:100vh;background:#f3faff;color:var(--navy);font-family:Poppins,Arial,sans-serif;padding:18px 8px;overflow-x:hidden}.page{width:min(1000px,100%);margin:0 auto}.shell{position:relative;border:1px solid #dbe8f1;background:linear-gradient(180deg,#fff 0%,#f8fcff 100%);min-height:650px;overflow:hidden;box-shadow:0 1px 0 rgba(0,60,120,.04)}
.header{margin:18px 14px 13px;border:1px solid #cfe7fa;border-radius:13px;background:linear-gradient(106deg,#0a4d9a 0%,#0875df 48%,#35a8ef 100%);height:132px;display:flex;align-items:center;justify-content:space-between;padding:14px 15px 14px 25px;position:relative;overflow:hidden;box-shadow:0 5px 16px rgba(20,104,176,.12)}.header:before{content:"";position:absolute;width:58%;height:190px;right:7%;top:-112px;border-radius:50%;background:linear-gradient(145deg,rgba(88,190,247,.24),rgba(255,255,255,0));transform:rotate(-16deg)}.header:after{content:"";position:absolute;width:46%;height:100px;right:11%;bottom:-65px;border-radius:50%;border-top:2px solid rgba(255,224,128,.62);transform:rotate(-10deg)}.brand{display:flex;align-items:center;gap:18px;position:relative;z-index:2}.brand-icon{width:122px;height:100px;display:grid;place-items:center;flex:none}.gold-mark{position:relative;width:45px;height:40px;display:block;flex:none}.gold-mark-large{width:112px;height:92px}.gold-mark .bar{position:absolute;display:block;background:linear-gradient(135deg,#fff6a5 0%,#ffd84b 28%,#d98b00 67%,#fff0a0 100%);border:1px solid rgba(164,102,0,.5);box-shadow:0 3px 4px rgba(95,56,0,.2);border-radius:4px;transform:skewX(-17deg)}.gold-mark .bar-a{width:28px;height:13px;left:1px;top:18px}.gold-mark .bar-b{width:28px;height:13px;left:11px;top:9px}.gold-mark .bar-c{width:24px;height:12px;left:21px;top:21px}.gold-mark .purity{position:absolute;left:7px;top:21px;font-size:6px;line-height:1;color:#744900;font-weight:900;z-index:4;white-space:nowrap}.gold-mark-large .bar-a{width:65px;height:30px;left:3px;top:40px}.gold-mark-large .bar-b{width:65px;height:30px;left:28px;top:19px}.gold-mark-large .bar-c{width:55px;height:27px;left:49px;top:48px}.gold-mark-large .purity{left:12px;top:48px;font-size:10px}.brand-title{font-size:42px;line-height:1.02;font-weight:800;letter-spacing:-1.5px;color:#fff}.brand-sub{font-size:16px;font-weight:500;color:#d9efff;margin-top:8px}.dot{display:inline-block;width:5px;height:5px;border-radius:50%;background:#fff;margin:0 9px 2px}.datetime{position:relative;z-index:3;width:205px;background:rgba(255,255,255,.97);border:1px solid #d4e9f9;border-radius:8px;padding:11px 13px;box-shadow:0 3px 12px rgba(0,55,110,.14)}.date{font-size:17px;font-weight:800;text-align:center;color:#0c3d79}.time{font-size:13px;font-weight:700;text-align:center;margin-top:9px;white-space:nowrap;color:#173f70}.hkflag{width:22px;height:16px;vertical-align:-3px;margin-right:7px}
...
@media(max-width:600px){.header{margin:10px 7px;padding:11px;min-height:150px;flex-direction:column;align-items:stretch;gap:8px}.brand{justify-content:center;gap:10px}.brand-icon{width:76px;height:65px}.gold-mark-large{width:70px;height:62px}.gold-mark-large .bar-a{width:40px;height:19px;left:2px;top:28px}.gold-mark-large .bar-b{width:40px;height:19px;left:17px;top:14px}.gold-mark-large .bar-c{width:34px;height:17px;left:30px;top:32px}.gold-mark-large .purity{left:8px;top:32px;font-size:7px}.brand-title{font-size:27px;letter-spacing:-.8px}.brand-sub{font-size:11px;margin-top:4px}.datetime{width:100%;padding:8px}.date{font-size:15px}.time{font-size:12px}.main{margin:0 7px;gap:10px}.cardbar{height:55px;padding:0 12px}.gold-heading{font-size:18px}.small-gold{width:43px;height:39px}.rates-inner{padding:10px}.thead{grid-template-columns:1fr 125px;padding:0 12px;font-size:12px}.quote-row{grid-template-columns:1fr 125px;min-height:69px;padding:8px 11px}.product-wrap{gap:9px}.product-icon{width:42px;height:42px}.gold-mark{width:34px;height:31px}.gold-mark .bar-a{width:21px;height:9px}.gold-mark .bar-b{width:21px;height:9px;left:8px;top:7px}.gold-mark .bar-c{width:18px;height:8px;left:16px;top:16px}.gold-mark .purity{font-size:4.7px;left:4px;top:16px}.product{font-size:13px}.prices{font-size:20px;gap:6px}.rate-arrow{font-size:16px}.rules-title{height:55px;font-size:17px;padding:0 12px}.info{width:34px;height:34px;font-size:19px}.rule{grid-template-columns:38px 1fr;gap:8px;padding:11px 0}.rule-num{width:35px;height:35px;font-size:12px}.rule p{font-size:11px;line-height:1.48}.bottom-art{height:70px}.skyline{width:75%;height:56px}}
