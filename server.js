...
<style>body{font-family:Arial,Helvetica,sans-serif;background:#f5f5f5;margin:0;padding:30px}.box{max-width:650px;margin:auto;background:#fff;border:1px solid #c59a22;border-radius:18px;padding:25px;box-shadow:0 10px 28px rgba(0,0,0,.08)}h1{margin-top:0}.row{display:grid;grid-template-columns:1fr 150px;gap:12px;margin:12px 0}.row input{padding:12px;border:1px solid #ccc;border-radius:8px;font-size:18px}button{margin-top:15px;padding:12px 22px;border:0;border-radius:9px;background:#c59a22;color:#fff;font-weight:700;font-size:18px;cursor:pointer}.msg{margin-top:15px;font-weight:700}.lightning,.bolt,.zap,.lightning-symbol{display:none!important}

@media(max-width:600px){.header.header-datetime-only{margin:8px 5px 10px!important;padding:0 12px!important;height:82px!important;min-height:82px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;border-radius:11px!important}.header.header-datetime-only .datetime{width:auto!important;min-width:0!important;padding:0!important;background:transparent!important;border:0!important;box-shadow:none!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important}.header.header-datetime-only .date{font-size:29px!important;line-height:1!important;font-weight:800!important;color:#fff!important}.header.header-datetime-only .time{font-size:14px!important;line-height:1!important;margin-top:6px!important;color:#fff!important}.header.header-datetime-only .hkflag{width:19px!important;height:13px!important;margin-right:5px!important}.main{margin:0 5px!important;gap:9px!important}.cardbar{height:52px!important}.small-gold{width:44px!important;height:42px!important}.gold-mark{width:39px!important;height:32px!important}.gold-mark:before{left:4px!important;top:6px!important;width:30px!important;height:18px!important}.gold-mark:after{left:19px!important;top:15px!important;font-size:7.5px!important}.gold-heading{font-size:19px!important;gap:8px!important}.product-icon{width:42px!important;height:42px!important}.product-icon:after{font-size:8.5px!important}.product-wrap{gap:9px!important}.product{font-size:15px!important}.prices{font-size:21px!important}.rate-arrow{font-size:17px!important}.thead,.quote-row{grid-template-columns:1fr 112px!important}}
@media(max-width:390px){.header.header-datetime-only{height:76px!important;min-height:76px!important}.header.header-datetime-only .date{font-size:27px!important}.header.header-datetime-only .time{font-size:13px!important}.product-icon{width:39px!important;height:39px!important}.product{font-size:14px!important}.prices{font-size:20px!important}.thead,.quote-row{grid-template-columns:1fr 105px!important}}
...
*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:linear-gradient(145deg,#eaf5ff 0%,#f7fbff 48%,#e3f1ff 100%);color:var(--text);font-family:Arial,Helvetica,sans-serif}body{padding:24px 14px 40px;overflow-x:hidden}.page{width:min(1120px,100%);margin:auto}.shell{position:relative;overflow:hidden;border:1px solid #cfe4f7;border-radius:28px;background:linear-gradient(145deg,rgba(255,255,255,.99),rgba(242,249,255,.99));box-shadow:var(--shadow)}.shell:before{content:"";position:absolute;width:480px;height:480px;right:-220px;top:-240px;border-radius:50%;background:radial-gradient(circle,rgba(24,132,223,.12),transparent 67%);pointer-events:none}.shell:after{content:"";position:absolute;width:400px;height:400px;left:-230px;bottom:-250px;border-radius:50%;background:radial-gradient(circle,rgba(80,174,240,.12),transparent 68%);pointer-events:none}
.header{position:relative;margin:18px;min-height:150px;padding:28px 30px;border:1px solid #c7e1f7;border-radius:22px;background:linear-gradient(135deg,#0752a0 0%,#0b69bf 52%,#1a8ce2 100%);display:flex;align-items:center;justify-content:space-between;gap:24px;overflow:hidden;box-shadow:0 14px 34px rgba(10,92,166,.18)}.header:after{content:"999.9";position:absolute;right:-12px;bottom:-44px;font-family:Arial,Helvetica,sans-serif;font-size:152px;font-weight:700;letter-spacing:-8px;color:rgba(255,255,255,.075);pointer-events:none}.datetime{position:relative;z-index:1}.date{font-family:Arial,Helvetica,sans-serif;font-size:42px;line-height:1;font-weight:700;letter-spacing:-1.5px;color:#fff}.time{margin-top:10px;display:flex;align-items:center;gap:7px;font-size:15px;font-weight:600;color:rgba(255,255,255,.86);letter-spacing:.3px}.hkflag{width:22px;height:15px;flex:none;border-radius:3px;box-shadow:0 0 0 1px rgba(255,255,255,.24)}
.market-status{position:relative;z-index:2;display:flex;align-items:center;gap:10px;padding:10px 14px;border:1px solid rgba(255,255,255,.28);border-radius:999px;background:rgba(255,255,255,.14);color:#fff;font-size:14px;font-weight:700;backdrop-filter:blur(8px)}.status-dot{width:8px;height:8px;border-radius:50%;background:#42e69d;box-shadow:0 0 0 5px rgba(66,230,157,.12),0 0 14px rgba(66,230,157,.55)}
.main{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1.25fr) minmax(310px,.75fr);gap:18px;margin:0 18px}.card{border:1px solid #cfe4f7;border-radius:22px;background:linear-gradient(145deg,#ffffff 0%,#f8fcff 100%);box-shadow:0 15px 40px rgba(25,102,168,.11);overflow:hidden}.cardbar{height:76px;padding:0 22px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line);background:linear-gradient(90deg,#f1f8ff,transparent)}.gold-heading{display:flex;align-items:center;gap:13px;font-family:Arial,Helvetica,sans-serif;font-size:22px;font-weight:700;color:#0a4688}.small-gold{width:52px;height:52px;border-radius:50%;display:grid;place-items:center;border:2px solid #e8bd55;background:radial-gradient(circle at 30% 25%,#fff7c9 0%,#f8d76e 24%,#d99b22 58%,#9a5f08 100%);box-shadow:inset 0 2px 2px rgba(255,255,255,.92),inset 0 -3px 4px rgba(117,67,4,.35),0 7px 16px rgba(180,125,22,.18)}.gold-mark{position:relative;width:40px;height:40px;border-radius:50%;background:radial-gradient(circle at 35% 28%,#fff4b8 0%,#f0c85c 35%,#c98717 72%,#8f5607 100%);border:2px solid rgba(255,244,177,.8);box-shadow:inset 0 1px 2px rgba(255,255,255,.8),inset 0 -2px 3px rgba(96,54,2,.32),0 3px 7px rgba(117,67,4,.2);display:grid;place-items:center;overflow:hidden}.gold-mark:before{content:"";position:absolute;inset:5px;border:1px solid rgba(255,242,167,.78);border-radius:50%;box-shadow:inset 0 0 0 1px rgba(137,82,7,.28)}.gold-mark:after{content:"999.9";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);color:#8a5709;font-family:Arial,Helvetica,sans-serif,Arial,sans-serif;font-size:10px;font-weight:800;letter-spacing:.2px;text-shadow:0 1px rgba(255,238,160,.8);z-index:2}.trend{width:34px;height:34px;border:1px solid #cce2f7;border-radius:10px;display:grid;place-items:center;color:var(--blue2);font-size:22px;background:#f1f8ff}
.rates-inner{padding:0 12px 12px}.rates-only{padding-top:2px}.thead{display:grid;grid-template-columns:1fr 175px;gap:12px;padding:18px 12px 12px;color:#5f7693;font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:.65px}.thead div:last-child{text-align:right}.quote-row{display:grid;grid-template-columns:1fr 175px;align-items:center;min-height:76px;padding:9px 12px;margin:7px 0;border:1px solid #e0edf8;border-radius:15px;background:#f8fbfe;transition:.2s ease}.quote-row:hover{border-color:#acd2f1;background:#f0f8ff;transform:translateY(-1px);box-shadow:0 7px 18px rgba(24,132,223,.08)}.product-wrap{display:flex;align-items:center;gap:12px;min-width:0}.product-icon{width:50px;height:50px;flex:none;display:grid;place-items:center;border-radius:50%;background:linear-gradient(145deg,#fffaf0,#f5d477);border:1px solid rgba(217,155,31,.32);box-shadow:0 6px 14px rgba(180,125,22,.12)}.product-icon .gold-mark{transform:scale(.9)}.product{min-width:0;color:#164f8e;font-size:16px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.prices{display:flex;align-items:center;justify-content:flex-end;gap:8px;font-family:Arial,Helvetica,sans-serif;font-size:26px;font-weight:700;letter-spacing:-.6px;color:#083f7d;font-variant-numeric:tabular-nums lining-nums}.rate-arrow{font-family:Arial;font-size:15px;font-weight:800}.rate-arrow.up{color:var(--green)}.rate-arrow.down{color:var(--red)}.same{color:#7d98b5}
.rules-title{height:76px;padding:0 22px;display:flex;align-items:center;gap:12px;border-bottom:1px solid var(--line);font-family:Arial,Helvetica,sans-serif;font-size:22px;font-weight:700;color:#0a4688}.info{width:36px;height:36px;display:grid;place-items:center;border-radius:11px;border:1px solid #b9daf4;background:#edf7ff;color:#0d70c7;font:700 21px Georgia}.rules-body{padding:8px 20px 12px}.rule{display:grid;grid-template-columns:40px 1fr;gap:12px;padding:17px 0;border-bottom:1px solid var(--line)}.rule:last-child{border-bottom:0}.rule-num{width:36px;height:36px;display:grid;place-items:center;border-radius:10px;background:#edf7ff;border:1px solid #c6e2f7;color:#0b69b8;font-size:13px;font-weight:800}.rule p{margin:1px 0 0;color:#5f7897;font-size:14px;line-height:1.62}.rule b{color:#164f8e;font-weight:700}.bottom-art{height:100px;position:relative;overflow:hidden}.bottom-art:before{content:"";position:absolute;left:5%;right:5%;top:55px;height:1px;background:linear-gradient(90deg,transparent,#b8d8f2,transparent)}
@media(max-width:850px){body{padding:12px 8px 28px}.header{min-height:125px;padding:23px}.date{font-size:35px}.main{grid-template-columns:1fr}.market-status{position:absolute;right:18px;bottom:18px}.header:after{font-size:117px}.bottom-art{height:55px}}
@media(max-width:600px){body{padding:7px 5px 18px}.shell{border-radius:19px}.header{margin:8px;min-height:108px;padding:18px 17px;border-radius:16px}.date{font-size:29px;letter-spacing:-1px}.time{font-size:12px;margin-top:7px}.hkflag{width:19px;height:13px}.market-status{right:14px;bottom:14px;padding:7px 10px;font-size:12px}.status-dot{width:6px;height:6px}.main{margin:0 8px;gap:10px}.card{border-radius:16px}.cardbar{height:62px;padding:0 13px}.gold-heading{font-size:19px;gap:9px}.small-gold{width:43px;height:43px;border-radius:50%}.trend{width:30px;height:30px}.rates-inner{padding:0 7px 7px}.thead{grid-template-columns:1fr 128px;padding:13px 8px 9px;font-size:10.5px;letter-spacing:.35px}.quote-row{grid-template-columns:1fr 128px;min-height:64px;padding:7px 8px;margin:5px 0;border-radius:12px}.product-wrap{gap:8px}.product-icon{width:40px;height:40px;border-radius:50%}.product-icon .gold-mark{transform:scale(.78)}.product{font-size:14px}.prices{font-size:21px;gap:6px}.rate-arrow{font-size:13px}.rules-title{height:62px;padding:0 14px;font-size:19px;gap:9px}.info{width:31px;height:31px;font-size:19px}.rules-body{padding:3px 13px 8px}.rule{grid-template-columns:34px 1fr;gap:9px;padding:12px 0}.rule-num{width:32px;height:32px;font-size:12px}.rule p{font-size:12.5px;line-height:1.55}.bottom-art{height:35px}}
@media(max-width:390px){.date{font-size:26px}.market-status{font-size:11px}.thead,.quote-row{grid-template-columns:1fr 116px}.product{font-size:13px}.prices{font-size:20px}.rules-title{font-size:18px}}
...
<main class="main"><section class="card"><div class="rates-inner rates-only"><div class="thead"><div>PRODUCT (GOLD - 999.9)</div><div>USD RATE / GRAM</div></div><div id="rows"></div></div></section>
