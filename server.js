...
@media(max-width:600px){.header{margin:10px 8px 10px;padding:12px;flex-direction:column;align-items:stretch;gap:10px}.brand{justify-content:center}.brand-icon{width:65px;height:60px}.brand-title{font-size:24px}.brand-sub{font-size:11px;margin-top:5px}.datetime{width:100%;padding:9px}.date{font-size:15px}.time{font-size:12px}.main{margin:0 8px;gap:10px}.cardbar{height:56px;padding:0 13px}.gold-heading{font-size:18px}.small-gold{width:43px;height:39px}.rates-inner{padding:10px}.thead{grid-template-columns:1fr 125px;padding:0 12px;font-size:12px}.quote-row{grid-template-columns:1fr 125px;min-height:68px;padding:8px 11px}.product-wrap{gap:9px}.product-icon{width:43px;height:41px}.product{font-size:13px}.prices{font-size:21px;gap:7px}.rules-title{height:56px;font-size:17px;padding:0 13px}.info{width:35px;height:35px;font-size:20px}.rule{grid-template-columns:39px 1fr;gap:8px;padding:11px 0}.rule-num{width:36px;height:36px;font-size:12px}.rule p{font-size:11.5px;line-height:1.45}.bottom-art{height:68px}.skyline{width:75%;height:58px}}
...
<header class="header"><div class="brand"><div class="brand-icon"><svg viewBox="0 0 96 78" width="88" height="76" aria-hidden="true"><defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff6a8"/><stop offset=".35" stop-color="#ffc51b"/><stop offset="1" stop-color="#c87500"/></linearGradient><linearGradient id="g2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffe45b"/><stop offset="1" stop-color="#e38a00"/></linearGradient></defs><path d="M15 54 34 39l20 7-18 17z" fill="url(#g2)" stroke="#c97800" stroke-width="1"/><path d="M35 39 54 25l20 7-20 14z" fill="url(#g1)" stroke="#c97800" stroke-width="1"/><path d="M54 46 74 31l12 8-18 16z" fill="url(#g2)" stroke="#c97800" stroke-width="1"/><path d="M7 63 27 49l18 7-20 15z" fill="url(#g1)" stroke="#c97800" stroke-width="1"/><path d="M26 49 46 34l18 7-19 15z" fill="url(#g2)" stroke="#c97800" stroke-width="1"/><path d="M31 28 52 13l18 6-20 15z" fill="url(#g1)" stroke="#c97800" stroke-width="1"/></svg></div><div><div class="brand-title">Live Gold Rates</div><div class="brand-sub">Market Rates <span class="dot"></span> Your Trusted Source</div></div></div><div class="datetime"><div id="date" class="date">--</div><div class="time"><svg class="hkflag" viewBox="0 0 24 17"><rect width="24" height="17" rx="2" fill="#DE2910"/><path d="M8.4 4.7c-1.9-1-3.7.5-3 2.2.45 1.1 1.7 1.5 2.8.8-1.15.15-1.85-.7-1.55-1.45.28-.67 1.08-.94 1.75-.86Z" fill="#fff"/><circle cx="9.2" cy="5.5" r=".6" fill="#fff"/><circle cx="7.4" cy="4.2" r=".6" fill="#fff"/><circle cx="6.2" cy="6.7" r=".6" fill="#fff"/><circle cx="8.8" cy="7.8" r=".6" fill="#fff"/></svg><span id="time">--:--:-- -- HKT</span></div></div></header>
<main class="main"><section class="card"><div class="cardbar"><div class="gold-heading"><div class="small-gold"><svg viewBox="0 0 64 56" width="47" height="42"><defs><linearGradient id="sg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff2a0"/><stop offset=".45" stop-color="#ffc21a"/><stop offset="1" stop-color="#d57c00"/></linearGradient></defs><path d="M8 40 23 28l16 6-15 13z" fill="url(#sg)"/><path d="M24 28 39 16l16 6-16 12z" fill="url(#sg)"/><path d="M40 34 55 22l8 6-15 12z" fill="url(#sg)"/><path d="M4 48 20 36l14 5-16 11z" fill="url(#sg)"/><path d="M20 36 36 23l15 6-16 12z" fill="url(#sg)"/><path d="M25 18 41 6l14 5-16 12z" fill="url(#sg)"/></svg></div><span>Gold (999.9)</span></div><div class="trend">⌁</div></div><div class="rates-inner"><div class="thead"><div>Product</div><div>USD Rate / Gram</div></div><div id="rows"></div></div></section>
