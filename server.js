...
/* DESIGN 01 - Azure Glass */
:root{--blue:#1268d8;--blue2:#48b9ff;--blue3:#edf8ff;--gold:#d7a62a;--ink:#123d72;--muted:#6a87a8;--line:#d7eafa;--paper:#f4faff}
body{font-family:"Trebuchet MS","Segoe UI",Arial,sans-serif;background:radial-gradient(circle at 10% 0%,#ffffff 0,#f4faff 42%,#e8f4ff 100%);padding:18px 14px 30px}
.dashboard{width:min(1120px,100%)}
.hero{border:1px solid #c5e1f8;border-radius:24px;padding:18px 22px;background:linear-gradient(115deg,rgba(255,255,255,.98),rgba(235,247,255,.96));box-shadow:0 14px 34px rgba(29,105,170,.13)}
.brand{gap:18px}.brand-mark{width:88px;height:76px;border-radius:22px;background:linear-gradient(145deg,#fff6cf,#e7b52e);font-size:0;box-shadow:inset 0 0 0 1px #e6c66a,0 8px 18px rgba(201,157,32,.22)}.brand-mark:after{content:"🪙";font-size:46px;filter:saturate(1.1)}
.hero-title{font-family:Georgia,"Times New Roman",serif;font-size:clamp(29px,4.2vw,43px);letter-spacing:-1.2px}.tagline{font-size:15px}.hero-right{min-width:225px;border-radius:17px;background:#fff;border:1px solid #cfe5f8;box-shadow:0 8px 20px rgba(28,100,160,.10);padding:13px 17px}.date{font-size:19px;color:#123f78}.time-row{font-size:14px;color:#174b82}
.content-grid{grid-template-columns:minmax(0,1.62fr) minmax(320px,1fr);gap:18px;margin-top:18px}.panel{border-radius:20px;border:1px solid #cfe5f6;box-shadow:0 12px 30px rgba(27,93,145,.11)}.panel-head{padding:13px 17px;background:linear-gradient(100deg,#096de0,#42b5fa);font-family:Georgia,"Times New Roman",serif;font-size:20px;letter-spacing:.1px}.panel-icon{width:39px;height:39px;background:linear-gradient(145deg,#ffe9a8,#d99d16);border-color:#fff8dc;color:#fff;font-size:20px}.panel:first-child .panel-icon{font-size:0}.panel:first-child .panel-icon:after{content:"🪙";font-size:21px}.rate-head{margin-top:2px;border-radius:11px;background:linear-gradient(90deg,#e8f5ff,#f5fbff);padding:11px 15px;font-size:13px}.rate-body{border-radius:0 0 12px 12px}.quote-row{min-height:72px;padding:11px 15px}.product{font-size:16px;padding-left:36px}.prices{font-family:"Trebuchet MS","Segoe UI",sans-serif;font-size:clamp(22px,3.2vw,28px);color:#0877df}.rate-arrow{font-size:16px}.rule{padding:12px 5px}.rule-num{background:linear-gradient(145deg,#4dbbff,#086edb);box-shadow:0 5px 13px rgba(10,109,219,.18)}.rule p{font-size:12.5px;line-height:1.55}.footer{margin-top:15px;color:#6b86a2}
