...
</style></head><body><main class="dashboard"><section class="date-card"><div id="date" class="date">--</div></section><div class="live-row"><span class="hk-flag">🇭🇰</span><span id="time">--:--:-- -- HKT</span></div><section class="quote-card"><div class="quote-head"><div>Product (999.9)</div><div style="text-align:right">USD Rate / Gram</div></div><div id="rows"></div></section><section class="notes-section"><div class="notes-title-row"><div class="notes-line"></div><div class="notes-title">📝 Note:</div><div class="notes-line right"></div></div><div class="notes-card"><div class="note"><span class="note-dot"></span><span>Note 1 sample</span></div><div class="note"><span class="note-dot"></span><span>Note 2 sample</span></div><div class="note"><span class="note-dot"></span><span>Note 3 sample</span></div></div></section><div class="footer"><span class="footer-icon"></span><span>Prices update in real-time</span></div></main>
